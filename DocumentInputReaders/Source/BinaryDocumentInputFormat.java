...
public class BinaryDocumentInputFormat
	...
	public RecordReader<NullWritable, BytesWritable> getRecordReader(
		...
		return new BinaryDocumentRecordReader((FileSplit) split, job);		
	}
	
	public class BinaryDocumentRecordReader
		...
		public BinaryDocumentRecordReader(FileSplit fileSplit, Configuration conf)
			throws IOException {
